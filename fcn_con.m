function [ ineqval, eqval,ineqgrad, eqgrad] = fcn_con( Uctrl,pS,pEst,dt,sensor_model,Nside,gpreg,threshold_track, threshold_obstacle )
...
% Cvis = sum(Cvis);
% %a2=0; a3=0;
% Cost = a1* Ctrack + a3*Cvis;
% grad = a1* Ctrack_gr_u + a3*Cvis_gr_u;
